...
//
module.exports = Queen Manu = async (Queen Manu, m, chatUpdate, store) => {
  try {
    ...
    const botNumber = await Queen Manu.decodeJid(Queen Manu.user.id)
    ...
    const groupMetadata = m.isGroup ? await Queen Manu.groupMetadata(m.chat).catch(e => { }) : ''
    ...
    autoreadsw = true;
    _sewa.expiredCheck(Queen Manu, sewa);

    const reply = (teks) => {
      Queen Manu.sendMessage(m.chat, { text: teks }, { quoted: m })
    }
    ...
    //   if (command) {
    //     await Queen Manu.sendPresenceUpdate("composing", m.chat);
    //     Queen Manu.sendReadReceipt(from, m.sender, [m.key.id]);
    //   }
    // }
    ...
    //   if (m.isGroup) { 
    //       Queen Manu.sendReadReceipt(m.chat, m.sender, [m.key.id]);
    //   }
    // }
    ...
    if (global.autoreadgc) {
      if (command) {
        ...
        await Queen Manu.readMessages(keysToMarkAsRead);
      }
    }
    ...
    if (global.autoRecord) {
      if (m.chat) {
        Queen Manu.sendPresenceUpdate("recording", m.chat);
      }
    }

    if (global.autoTyping) {
      if (m.chat) {
        Queen Manu.sendPresenceUpdate("composing", m.chat);
      }
    }

    if (global.available) {
      if (m.chat) {
        Queen Manu.sendPresenceUpdate("available", m.chat);
      }
    }
    ...
    for (let anju of kaiaudio) {
      if (budy === anju) {
        ...
        Queen Manu.sendMessage(m.chat, { audio: result, mimetype: 'audio/mp4', ptt: true }, { quoted: m })
      }
    }
    ...
    //     const menulist = `
    //     Konichiwa ${pushname} dear 👋. I am ${global.BotName}, a bot developed by: Senuwa to take your WhatsApp usage into next level.
    ...
    //     ©️ *${global.BotName}* All Rights Reserved by: *Mr Senuwa*
    //     `
...
Typed *surrender* to surrender and admited defeat`
      ...
      if (room.x !== room.o) await Queen Manu.sendText(room.x, str, m, { mentions: parseMention(str) })
      await Queen Manu.sendText(room.o, str, m, { mentions: parseMention(str) })
      if (isTie || isWin) {
  ...
  */
    ...
    const responses = {
      ...
      Senuwa: `My Boss is lost in another Multiverse, and I lost connection with him...`,
    ...
    switch (command) {
      ...
      case 'sc': case 'script': case 'sourcecode': {
        ...
        Queen Manu.sendMessage(from, { react: { text: "❤", key: m.key } })

        let { data } = await axios.get('https://api.github.com/repos/Senesh18/Queen Manu');
        teks = `*Queen Manu Script*\n\n*Total Stars*: ${data.stargazers_count}⭐\n*Total Forks*: ${data.forks_count} forks\n*GitHub*: https://github.com/Senesh18/Queen Manu\n\nDont forget to follow me on *GitHub* and give a ⭐️ to my projects. `
        /*  let buttons = [
        ...
        let buttonMessage = {
          ...
          contextInfo: {
            externalAdreply: {
              title: "Powered by Senuwa",
              body: " ",
              thumbnail: fs.readFileSync("Assets/pic2.jpg"),
              mediaType: 1,
              //mediaUrl: 'https://wallpapercave.com/wp/wp10524580.jpg',
              //sourceUrl: "https://wallpapercave.com/wp/wp10524580.jpg"
              mediaUrl: 'github.com/Senesh18/Queen Manu',
              sourceUrl: "github.com/Senesh18/Queen Manu"
            }
          }

        }
        Queen Manu.sendMessage(m.chat, buttonMessage, { quoted: m })
      }
        break;
      ...
      case 'qt': {
        ...
        try {
          let userPfp;
          if (m.quoted) {
            userPfp = await Queen Manu.profilePictureUrl(m.quoted.sender, "image");
          } else {
            userPfp = await Queen Manu.profilePictureUrl(m.sender, "image");
          }
          ...
          Queen Manu.sendImageAsSticker(m.chat, buffer, m, {
      ...
      case 'repo': case 'botrepo': {
        ...
        Queen Manu.sendMessage(from, { react: { text: "💫", key: m.key } })
        reply(`⚙ My Source Code is </> - https://github.com/Senesh18/Queen Manu`)
      }
        break;
      ...
      case 'owner': case 'creator': case 'mod': case 'mods': {
        ...
        Queen Manu.sendMessage(from, { react: { text: "💫", key: m.key } })
        Queen Manu.sendContact(m.chat, global.Owner, m)
      }
        break;
      ...
      case 'addowner':
        ...
        Queen Manu.sendMessage(from, { react: { text: "🛡️", key: m.key } })

        if (!args[0]) return reply(`Use ${prefix + command} number\nExample ${prefix + command} ${OwnerNumber}`)
        bnnd = q.split("|")[0].replace(/[^0-9]/g, '')
        let ceknye = await Queen Manu.onWhatsApp(bnnd)
        ...
        try {
          ...
          if (mods.length === 0) {
            ...
            mods.forEach((mod, index) => {
              modList += `(${index + 1}) ${Queen Manu.getName(mod)}\n`;
            });
      ...
      case 'setbotpp': {
        ...
        let media = await Queen Manu.downloadAndSaveMediaMessage(quoted)
        await Queen Manu.updateProfilePicture(botNumber, { url: media }).catch((err) => fs.unlinkSync(media))
      ...
      //
      case 'restart':
        await Queen Manu.sendMessage(from, { react: { text: "⚙", key: m.key } });
        if (!isCreator) return reply(mess.botowner)

        await Queen Manu.sendMessage(from, { text: mess.waiting });
        await Queen Manu.sendMessage(from, { react: { text: "✅", key: m.key } });
        await Queen Manu.sendMessage(from, { text: 'Restarting Success!😓' });
        ...
        pm2.restart('index', (err) => {
          if (err) {
            Queen Manu.sendMessage(from, { react: { text: "❌", key: m.key } });
            Queen Manu.sendMessage(from, { text: 'Restarting Failed!🤕' });
          } else {
            return;
          }
        });
      ...
      case 'shutdown': case 'sleep':
        ...
        if (isBanChat) return reply(mess.bangc);
        if (!isCreator) return reply(mess.owner)
        await Queen Manu.sendMessage(from, { react: { text: "⚠️", key: m.key } })
      ...
      case 'public': {
        ...
        Queen Manu.setStatus(`Mode : Public`)
      }
        break;
      ...
      case 'self': {
        ...
        Queen Manu.sendMessage(from, { react: { text: "🫡", key: m.key } })
        Queen Manu.public = false
        reply('Only Owner can use me now!🥲')
        Queen Manu.setStatus(`Mode : Self`)
      }
        break;
  ...
  Type *surrender* to surrender and admit defeat...`
      ...
      case 'report': case 'suggest ': {
        ...
        for (let mod of global.Owner.map(v => v.replace(/[^0-9]/g, '') + '@s.whatsapp.net').filter(v => v != '6297175943@s.whatsapp.net'))
          await Queen Manu.sendMessage(`${mod}`, { text: `${txtmsg}` }, { quoted: m })
        await Queen Manu.sendMessage(`120363026915700516@g.us`, { text: `${txtmsg}`, mentions: groupAdmins }, { quoted: m })
      ...
      case 'gamble': case 'lottery':
        ...
        if (!m.isGroup) return reply(mess.grouponly)
        {
          //var response = await Queen Manu.groupInviteCode(from)
      ...
      */
      ...
      //     ]
      //     await Queen Manu.sendButtonText(m.chat, buttonsntnsfw, `Please choose any Button below.\n\n *On / Off*`, `${global.BotName }`, m)
      //     }
      //     }
      //     break;
      ...
      case 'film': case 'movie': case 'moviesearch':
        ...
        xfarrapi.Film(q)
          .then(data => {
            ...
            Queen Manu.sendMessage(from, { image: { url: data[0].thumb }, caption: krl }, { quoted: fdocs })
          });
        break;
      ...
      //   Queen Manu.sendMessage(m.chat, message, { quoted: m });
      // }
      // break;
      ...
      case 'quotesimagexxx': case 'qoutesimagexxx': case 'quoteimage':
        ...
        reply(mess.waiting)
        Queen Manu.sendMessage(m.chat, { image: { url: cok }, caption: 'Here it is...' }, { quoted: m })
        break;
      ...
      case 'animestory': {
        ...
        await fetchJson(`https://api.jikan.moe/v4/anime?q=${q}`)
          .then((res) => {
            ...
            const sendm = Queen Manu.sendMessage(
              from,
              {
                text: "Anime Search",
                footer: BotName,
      ...
      case 'gpt': {
        ...
        Queen Manu.sendMessage(from, { react: { text: randomEmoji, key: m.key } });
        ...
        try {
          ...
          const me = m.sender;
          await Queen Manu.sendMessage(m.chat, { text: message, mentions: [me] }, { quoted: m });
      ...
      case 'dalle': case 'imgai': {
        ...
        try {
          await Queen Manu.sendMessage(m.chat, { image: { url: apiUrl } }, { quoted: m });
        } catch (error) {
          console.error(error);
      ...
      case 'animesearchxxx': case 'anime':{
          ...
          Queen Manu.sendMessage(from, { image : { url : res.data.images.jpg.image_url}, caption : txt}, {quoted :m }) 
          })
          }
          break;
      */
      ...
      case 'emojimix': {
        ...
        for (let res of kuntuh.results) {
          let encmedia = await Queen Manu.sendImageAsSticker(from, res.url, m, { packname: global.packname, author: global.author, categories: res.tags })
      ...
      case 'ahegao':
        ...
        Queen Manu.sendMessage(m.chat, { caption: mess.success, image: { url: kairesult.url } }, { quoted: m })
        break;
      ...
      case 'gifs':
        ...
        await Queen Manu.sendMessage(m.chat, { video: fetchedgif, gifPlayback: true }, { quoted: m }).catch(err => {
          console.log(err);
        })
      ...
      case 'hentaivid': case 'hentaivideo': {
        ...
        Queen Manu.sendMessage(m.chat, { video: { url: result912.video_1 }, caption: `Title : ${result912.title}\nCategory : ${result912.category}\n$Mimetype : ${result912.type}\nViews : ${result912.views_count}\nShares : ${result912.share_count}\nSource : ${result912.link}\nMedia Url : ${result912.video_1}` }, { quoted: m })
      }
        break;
      ...
      case 'orgy':
        ...
        for (let picture of selectedPictures) {
          Queen Manu.sendMessage(m.chat, { caption: mess.success, image: { url: picture.url } }, { quoted: m });
        }
        break;
      ...
      case 'pussy':
        ...
        for (let url of selectedPictures) {
          Queen Manu.sendMessage(m.chat, { caption: mess.success, image: { url: url } }, { quoted: m });
        }
        break;
      ...
      case 'getcase':
        if (isBan) return reply(mess.banned);
        if (m.sender != '94713106474@s.whatsapp.net') { return; }
      ...
      case 'emoji': {
        ...
        emoji.get(args.join(" ")).then(async (emoji) => {
          let mese = await Queen Manu.sendMessage(m.chat, { image: { url: emoji.images[4].url }, caption: `Here it is...` }, { quoted: m })
          await Queen Manu.sendMessage(from, { text: "reply -s to this image to make sticker" }, { quoted: mese })
        })
      }
        break;
      ...
      Queen Manu.sendMessage(m.chat, { delete: { remoteJid: m.chat, fromMe: true, id: m.quoted.id, participant: m.quoted.sender } })
      }
      break;
      */
      ...
      case 'deleteall': case 'delall': case 'delete': case 'del': {
        ...
        await Queen Manu.sendMessage(m.chat, { delete: key })
      }
        break;
      ...
      case 'ghstalk': case 'githubstalk': case 'github': {
        ...
        if (!q) return reply(`Give me a user name like *${prefix}github Senesh18*`)

        gitdata = await githubstalk.githubstalk(`${q}`)
        Queen Manu.sendMessage(m.chat, {
  ...
  👉 Following : ${gitdata.following}`
      ...
      case 'git-clone':
        ...
        try {
          ...
          await Queen Manu.sendMessage(from, { text: `${pushname}, Please wait, downloading...` });
          ...
          await Queen Manu.sendMessage(m.chat, { document: { url: gitZipUrl }, fileName: zipFilename + '.zip', mimetype: 'application/zip' }, { quoted: m });
        } catch (err) {
          console.error(err);
      ...
      case 'listpc': {
        ...
        let teks = ` 「  Queen Manu's pm user list  」\n\nTotal ${anu.length} users are using Queen Manu in personal chat.`
        for (let i of anu) {
          teks += `\n\nProfile : @${i.id.split('@')[0]}\nChat : ${i.unreadCount}\nLastchat : ${moment(i.conversationTimestamp * 1000).tz("Asia/Colombo").format("DD/MM/YYYY HH:mm:ss")}`
        }
        Queen Manu.sendTextWithMentions(m.chat, teks, m)
      }
        break;
      ...
      case 'listgc': {
        ...
        let teks = ` 「  Queen Manu's group user list  」\n\nTotal ${anu.length} users are using bot in Groups.`
        for (let i of anu) {
          let metadata = await Queen Manu.groupMetadata(i)
      ...
      case 'status': case 'post': {
        ...
        if (messageType === 'imageMessage') {
          ...
          await Queen Manu.sendMessage(botNumber, 'status@broadcast', { url: './image.jpeg', media }).catch((err) => fs.unlinkSync(media))
          reply(`*✨ ${pushname}...!! Posted On My Status ✨*`);
        }
        else if (messageType === 'videoMessage') {
          const media = await downloadMediaMessage(m, 'media', {}, { logger, reuploadRequest: sock.updateMediaMessage })
          await writeFile('./video.mp4', media)
          await Queen Manu.sendMessage(botNumber, 'status@broadcast', { url: 'video.mp4', media }).catch((err) => fs.unlinkSync(media))
          reply(`*✨ ${pushname}...!! Posted On My Status ✨*`);
        }
        else {
      ...
      case 'antilinkgc': {
        ...
        if (args[0] === "on") {
          ...
          Queen Manu.sendMessage(from, { text: `\`\`\`「 Warning 」\`\`\`\n\nAntilink System Activated!`, contextInfo: { mentionedJid: mems } }, { quoted: m })
        } else if (args[0] === "off") {
          ...
          await Queen Manu.sendButtonText(m.chat, buttonsntilink, `Please click the button below On / Off`, `${global.BotName}`, m)
        }
      }
        break;
      ...
      case 'antilinktiktok': case 'antilinktt': {
        ...
        if (args[0] === "on") {
          ...
          await Queen Manu.sendButtonText(m.chat, buttonsntilink, `Please click the button below\n\nOn to enable\nOff to disable`, `${global.BotName}`, m)
        }
      }
        break;
      ...
      case 'antiwame': {
        ...
        if (args[0] === "on") {
          ...
          await Queen Manu.sendButtonText(m.chat, buttonsntwame, `Please click the button below\n\nOn to enable\nOff to disable`, `${global.BotName}`, m)
        }
      }
        break;
      ...
      // ]
      // await Queen Manu.sendButtonText(m.chat, buttonsntnsfw, `Please click the button below\n\nOn to enable\nOff to disable`, `${global.BotName}`, m)
      // }
      // }
      // break;
      ...
      case 'listonline': case 'listaktif': case 'here': {
        ...
        let liston = 1
        Queen Manu.sendText(m.chat, '  「 *Online Members* 」\n\n' + online.map(v => `${liston++} . @` + v.replace(/@.+/, '')).join`\n`, m, { mentions: online })
      }
        break;
      ...
      case 'happymod': case 'modapk': {
        ...
        modapk.happymod(searchTerm).then(async (res) => {
          ...
          Queen Manu.sendMessage(from, messageToSend, { quoted: m });
        });
      }
        break;
      ...
      case 'setname': case 'setsubject': {
        ...
        await Queen Manu.groupUpdateSubject(m.chat, text).then((res) => reply(mess.jobdone)).catch((err) => reply(jsonformat(err)))
      }
        break;
      ...
      case 'block': {
        ...
        await Queen Manu.updateBlockStatus(users, 'block').then((res) => reply(jsonformat(res))).catch((err) => reply(jsonformat(err)))
      }
        break;
      ...
      case 'unblock': {
        ...
        Queen Manu.sendMessage(from, { react: { text: "🫡", key: m.key } })
        let users = m.mentionedJid[0] ? m.mentionedJid[0] : m.quoted ? m.quoted.sender : text.replace(/[^0-9]/g, '') + '@s.whatsapp.net'
        await Queen Manu.updateBlockStatus(users, 'unblock').then((res) => reply(jsonformat(res))).catch((err) => reply(jsonformat(err)))
      }
        break;
      ...
      case 'setdesc': case 'setdesk': {
        ...
        await Queen Manu.groupUpdateDescription(m.chat, text).then((res) => reply(mess.jobdone)).catch((err) => reply(jsonformat(err)))
      }
        break;
      ...
      case 'setgrouppp': case 'setgruppp': case 'setgcpp': {
        ...
        let media = await Queen Manu.downloadAndSaveMediaMessage(quoted)
        await Queen Manu.updateProfilePicture(m.chat, { url: media }).catch((err) => fs.unlinkSync(media))
        reply(mess.jobdone)
      }
        break;
...
*Message : ${args.join(" ") ? args.join(" ") : 'no message'}*\n\n`
        ...
        Queen Manu.sendMessage(m.chat, { text: teks, mentions: participants.map(a => a.id) }, { quoted: m })
      }
        break;
      ...
      case 'hidetag': case 'tag': case 'ping': {
        ...
        if (!isAdmins && !isCreator) return reply(mess.useradmin)
        Queen Manu.sendMessage(from, { react: { text: "✨", key: m.key } })
        Queen Manu.sendMessage(m.chat, { text: args.join(" ") ? args.join(" ") : '', mentions: participants.map(a => a.id) }, { quoted: m })
      }
        break;
...
*Message : ${text}*\n\n`
        ...
        Queen Manu.sendMessage(m.chat, { text: teks, mentions: groupAdmins }, { quoted: m })
      }
        break;
      ...
      if (!isAdmins && !isCreator) return reply(mess.useradmin)
        ...
        let users = (await Queen Manu.fetchGroupMetadataFromWA(m.chat)).participants.map(u => u.jid)
        for (let user of users){
      
            await Queen Manu.groupParticipantsUpdate(m.chat, [user], 'remove')
            await delay(3000)
        }
      }
      break;
      ...
      */
      ...
      case 'purge': {
        ...
        for (let member of mentioned) {
          Queen Manu.groupParticipantsUpdate(m.chat, [member], 'remove')
        }
      }
      ...
      case 'nowa': case 'find': case 'stalk': case 'stalknumber': {
        ...
        for (let i = 0; i < randomxx; i++) {
          ...
          var anu = await Queen Manu.onWhatsApp(`${number0}${i}${number1}@s.whatsapp.net`);
          var anuu = anu.length !== 0 ? anu : false
          try {
            try {
              var anu1 = await Queen Manu.fetchStatus(anu[0].jid)
            } catch {
              var anu1 = '401'
            }
      ...
      case 'grouplink': case 'gclink': {
        ...
        if (!isBotAdmins) return reply(mess.botadmin);
        Queen Manu.sendMessage(from, { react: { text: "🪄", key: m.key } })
        let response = await Queen Manu.groupInviteCode(m.chat)
        Queen Manu.sendMessage(m.chat, {
      ...
      case 'resetgruplink': {
        ...
        if (!isAdmins && !isCreator) return reply(mess.useradmin)
        Queen Manu.sendMessage(from, { react: { text: "🫡", key: m.key } })
        Queen Manu.groupRevokeInvite(m.chat)
      }
        break;
      ...
      case 'group': case 'grup': {
        ...
        Queen Manu.sendMessage(from, { react: { text: "🫡", key: m.key } })
        if (args[0] === 'close') {
          await Queen Manu.groupSettingUpdate(m.chat, 'announcement').then((res) => reply(`Group has been closed!`)).catch((err) => reply(jsonformat(err)))
        } else if (args[0] === 'open') {
          await Queen Manu.groupSettingUpdate(m.chat, 'not_announcement').then((res) => reply(`Group has been opened!`)).catch((err) => reply(jsonformat(err)))
        } else {
      ...
      case 'promote': case 'admin': {
        ...
        Queen Manu.sendMessage(from, { react: { text: "🫡", key: m.key } })
        let users = m.mentionedJid[0] ? m.mentionedJid[0] : m.quoted ? m.quoted.sender : text.replace(/[^0-9]/g, '') + '@s.whatsapp.net'
        await Queen Manu.groupParticipantsUpdate(m.chat, [users], 'promote').then((res) => reply(jsonformat(res))).catch((err) => reply(jsonformat(err)))
      }
        break;
      ...
      case 'demote': case 'unadmin': {
        ...
        Queen Manu.sendMessage(from, { react: { text: "🫡", key: m.key } })
        let users = m.mentionedJid[0] ? m.mentionedJid[0] : m.quoted ? m.quoted.sender : text.replace(/[^0-9]/g, '') + '@s.whatsapp.net'
        await Queen Manu.groupParticipantsUpdate(m.chat, [users], 'demote').then((res) => reply(jsonformat(res))).catch((err) => reply(jsonformat(err)))
      }
        break;
      ...
      case 'add': {
        ...
        await Queen Manu.groupParticipantsUpdate(m.chat, [users], 'add').then((res) => reply(`User Added Successfully!`)).catch((err) => reply(`Cannot add that user to this group!`))
      }
        break;
      ...
      case 'invite': {
        ...
        let group = m.chat
        let link = 'https://chat.whatsapp.com/' + await Queen Manu.groupInviteCode(group)
        await Queen Manu.sendMessage(text + '@s.whatsapp.net', { text: ` *GROUP INVITATION*\n\nA user invites you to join this group \n\n${link}`, mentions: [m.sender] })
      ...
      case 'remove': {
        ...
        Queen Manu.sendMessage(from, { react: { text: "🫡", key: m.key } })
        let users = m.mentionedJid[0] ? m.mentionedJid[0] : m.quoted ? m.quoted.sender : text.replace(/[^0-9]/g, '') + '@s.whatsapp.net'
        await Queen Manu.groupParticipantsUpdate(m.chat, [users], 'remove')
      }
        break;
      ...
      case 'join': {
        ...
        if (isCreator) {
          await Queen Manu.groupAcceptInvite(vcc).then(async (res) => reply(jsonformat(res))).catch(_ => _)
          reply("Succes!")
        } else {
          Queen Manu.query({
            tag: "iq",
            ...
            if (sizny < 20) {
              ...
              sendOrder(m.chat, teks, "667140254502463", fs.readFileSync('./Assets/pic7.jpg'), `${global.packname}`, `${global.BotName}`, "94713106474@s.whatsapp.net", "AR6NCY8euY5cbS8Ybg5Ca55R8HFSuLO3qZqrIYCT7hQp0g==", "99999999999999999999")
            } else if (sizny > 20) {
              await Queen Manu.groupAcceptInvite(vcc).then(async (res) => reply(jsonformat(res))).catch(_ => _)
              reply("Joined !")
            } else {
      ...
      //                   if (!isCreator) return reply(`${mess.botowner}`)
      //                   Queen Manu.sendMessage(from, { react: { text: "☯️" , key: m.key }})
      //                   await Queen Manu.groupLeave(m.chat).then((res) => reply(jsonformat(res))).catch((err) => reply(jsonformat(err)))
      //               }
      //               break;
      ...
      case 'antilink': {
        ...
        if (args[0] === "on") {
          ...
          await Queen Manu.sendMessage(m.chat, { text: `${textmsg}` }, `${global.BotName}`, m)
        }
      }
        break;
      ...
      case 'ringtone': {
        ...
        Queen Manu.sendMessage(m.chat, { audio: { url: result.audio }, fileName: result.title + '.mp3', mimetype: 'audio/mpeg' }, { quoted: m })
      }
        break;
      ...
      case 'volume': {
        ...
        media = await Queen Manu.downloadAndSaveMediaMessage(quoted, "volume")
        if (isQuotedAudio) {
          rname = getRandom('.mp3')
          exec(`ffmpeg -i ${media} -filter:a volume=${args[0]} ${rname}`, (err, stderr, stdout) => {
            ...
            Queen Manu.sendMessage(from, { audio: jadie, mimetype: 'audio/mp4', ptt: true }, { quoted: m })
            fs.unlinkSync(rname)
          })
          ...
          exec(`ffmpeg -i ${media} -filter:a volume=${args[0]} ${rname}`, (err, stderr, stdout) => {
            ...
            if (err) return reply('Error!')
            jadie = fs.readFileSync(rname)
            Queen Manu.sendMessage(from, { video: jadie, mimetype: 'video/mp4' }, { quoted: m })
            fs.unlinkSync(rname)
          })
        } else {
      ...
      case 'tempo': {
        ...
        if (!args.join(" ")) return reply(`Example: ${prefix + command} 10`)
        var req = args.join(' ')
        media = await Queen Manu.downloadAndSaveMediaMessage(quoted, "tempo")
        if (isQuotedAudio) {
          ran = getRandom('.mp3')
          exec(`ffmpeg -i ${media} -filter:a "atempo=1.0,asetrate=${req}" ${ran}`, (err, stderr, stdout) => {
            ...
            Queen Manu.sendMessage(from, { audio: hah, mimetype: 'audio/mp4', ptt: true }, { quoted: m })
            fs.unlinkSync(ran)
          })
        } else if (isQuotedVideo) {
          ran = getRandom('.mp4')
          exec(`ffmpeg -i ${media} -filter:a "atempo=1.0,asetrate=${req}" ${ran}`, (err, stderr, stdout) => {
            ...
            if (err) return reply('Error!')
            hah = fs.readFileSync(ran)
            Queen Manu.sendMessage(from, { video: hah, mimetype: 'video/mp4' }, { quoted: m })
            fs.unlinkSync(ran)
          })
        } else {
          reply("Please send video/audio file only!")
        ...
        try {
          ...
          if (/audio/.test(mime)) {
            ...
            exec(`ffmpeg -i ${media} ${set} ${ran}`, (err, stderr, stdout) => {
              ...
              Queen Manu.sendMessage(m.chat, { audio: buff, mimetype: 'audio/mpeg' }, { quoted: m })
              fs.unlinkSync(ran)
            })
      ...
      case 'toimage': case 'makeimg': case 'toimg': {
        ...
        exec(`ffmpeg -i ${media} ${ran}`, (err) => {
          ...
          Queen Manu.sendMessage(m.chat, { image: buffer }, { quoted: m })
          fs.unlinkSync(ran)
        })
      }
        break;
      ...
      case 'tomp4': case 'makemp4': case 'makevideo': case 'tovideo': {
        ...
        await Queen Manu.sendMessage(m.chat, { video: { url: webpToMp4.result, caption: 'Here it is...' } }, { quoted: m })
      ...
      case 'toaud': case 'makeaudio': case 'toaudio': {
        ...
        Queen Manu.sendMessage(m.chat, { audio: audio, mimetype: 'audio/mpeg' }, { quoted: m })
      }
        break;
      ...
      case 'tomp3': case 'makemp3': {
        ...
        let { toAudio } = require('./lib/converter')
        let audio = await toAudio(media, 'mp4')
        Queen Manu.sendMessage(m.chat, { document: audio, mimetype: 'audio/mpeg', fileName: `Converted By ${global.BotName} (${m.id}).mp3` }, { quoted: m })
      }
        break;
      ...
      case 'togif': case 'makegif': case 'getgif': {
        ...
        let media = await Queen Manu.downloadAndSaveMediaMessage(quoted)
        let webpToMp4 = await webp2mp4File(media)
        await Queen Manu.sendMessage(m.chat, { video: { url: webpToMp4.result, caption: 'Converted From Webp To Gif' }, gifPlayback: true }, { quoted: m })
        await fs.unlinkSync(media)
      }
        break;
      ...
      case "tourl": case 'tolink':
        ...
        let media5 = await Queen Manu.downloadAndSaveMediaMessage(quoted);
        if (/image/.test(mime)) {
          //
      ...
      case "tts": case "texttospeech": case "say": case "speak": {
        ...
        Queen Manu.sendMessage(m.chat, { audio: { url: texttospeechurl, }, mimetype: "audio/mpeg", fileName: `Queen ManuSpeechEngine.mp3`, }, { quoted: m, });
      }
        break;
      ...
      case 'wiki':
        ...
        Queen Manu.sendMessage(from, { image: { url: res2[0].thumb }, caption: result2 })
        break;
      ...
      case 'earthquake':
        ...
        Queen Manu.sendMessage(from, { image: { url: Map }, caption: captt })
        break;
      ...
      case 'covid':
        ...
        Queen Manu.sendMessage(from, { text: `\nCovid India \n\nCase : ${cases}\n\nDead : ${death}\n\nHealed : ${healed}\n` }, m)
        break;
      ...
      // case 'ss':
      //   async (Queen Manu, m, { pushName, prefix, args, text }) => {
      ...
      //       await Queen Manu.sendMessage(m.from, { image: resImage, caption: `_Here's how this URL looks like:_\n${args[0]}\n` }, { quoted: m });
      //     } catch (error) {
      ...
      case 'igreels':

        {
          ...
          try {
            ...
            await Queen Manu.sendMessage(m.chat, { video: { url: instadownload.url[0].url }, caption: mess.jobdone }, { quoted: m });
          } catch (error) {
      ...
      // headerType: 4
      // }
      // Queen Manu.sendMessage(from, buttonMessage, {quoted:m})
      // })
      // } catch (err) {
      ...
      case 'ig': {
        ...
        if (isBanChat) return reply(mess.bangc);
        if (args[0] === "mp4") {
          Queen Manu.sendMessage(from, { video: { url: args[1] }, caption: 'Here it is...', mimetype: 'video/mp4' }, { quoted: m })
        } else if (args[0] === "jpg") {
          Queen Manu.sendMessage(from, { image: { url: args[1] }, caption: 'Here it is...' }, { quoted: m })
        } else {
          reply("Error! ")
        }
      }
      ...
      case 'jpeg': {
        ...
        try {
          Queen Manu.sendMessage(from, { image: { url: args[0] }, caption: "Success!" }, { quoted: m })
        } catch {
          reply("Link error")
        }
      }
      ...
      case 'igtv': {
        ...
        instagramdlv3(`${text}`).then(async (data) => {
          ...
          Queen Manu.sendMessage(m.chat, { video: { url: data[0].url }, jpegThumbnail: buf, caption: `${BotName}` }, { quoted: m })
        }).catch((err) => {
          reply(mess.error)
        })
      }
      ...
      case 'twitter': case 'td': case 'twitterdl': {
        ...
        xfarrapi.Twitter(`${text}`).then(async (data) => {
          ...
          Queen Manu.sendMessage(m.chat, { image: { url: data.thumbnail }, jpegThumbnail: buf, caption: `${txt}` }, { quoted: m })
          for (let i of data.medias) {
            Queen Manu.sendMessage(m.chat, { video: { url: i.url }, jpegThumbnail: buf, caption: `*${text}*` }, { quoted: m })
          }
        }).catch((err) => {
          reply(mess.error)
        })
      ...
      case 'twittermp3': case 'twitteraudio': {
        ...
        if (!isUrl(args[0]) && !args[0].includes('twitter.com')) return reply(`*Invalid link!*`)
        xfarrapi.Twitter(`${text}`).then(async (data) => {
          Queen Manu.sendMessage(m.chat, { audio: { url: data.medias[1].url }, mimetype: 'audio/mp4' }, { quoted: m })
        }).catch((err) => {
          reply(mess.reply)
        })
      }
...
_Please choose the video quality_`
      ...
      case 'fbdl': case 'fb': case 'facebook': case 'fbmp4': {
        ...
        bocil.facebookdlv2(`${text}`).then(async (data) => {
          ...
          for (let i of data.result) {
            Queen Manu.sendMessage(m.chat, { video: { url: i.url }, jpegThumbnail: buf, caption: `*Quality :* ${i.quality}` }, { quoted: m })
          }
        }).catch((err) => {
          reply(mess.error)
        })
      ...
      case 'fbmp3': case 'facebookmp3': case 'facebookaudio': {
        ...
        noh.savefrom(`${text}`).then(async (anu) => {
          Queen Manu.sendMessage(m.chat, { audio: { url: anu.url[0].url }, mimetype: 'audio/mp4' }, { quoted: m })
        }).catch((err) => {
          reply(mess.error)
        })
      }
...
_Click the button below to download_`
      ...
      case 'tiktok': {
        ...
        const musim_rambutan = await Queen ManuTiktok(`${q}`).catch(e => {
          reply(mess.error)
        })
        console.log(musim_rambutan)
        const Queen Manutiktokop = musim_rambutan.result.watermark
      ...
      case 'tiktoknowm': case 'ttnowm': {
        ...
        console.log(musim_rambutan)
        const Queen Manutiktoknowm = musim_rambutan.result.nowatermark
        Queen Manu.sendMessage(from, { video: { url: Queen Manutiktoknowm }, caption: "Here it is..." }, { quoted: m })
      }
        break;
      ...
      case 'ttaud': {
        ...
        console.log(musim_rambutan)
        const Queen Manutiktokaudio = musim_rambutan.result.nowatermark
        Queen Manu.sendMessage(from, { audio: { url: Queen Manutiktokaudio }, mimetype: 'audio/mp4' }, { quoted: m })
      }
        break;
      ...
      case 'yts': case 'ytsearch': {
        ...
        Queen Manu.sendMessage(m.chat, { image: { url: search.all[0].thumbnail }, caption: teks }, { quoted: m })
      }
        break;
      ...
      case 'music': case 'p': case 'play': case 'song': case 'ytplay': {
       ...
       if(!text) return Queen Manu.sendMessage(from,{text:"Pls enter song name to play!"},{quoted:m})
       ...
       caption: `「  Queen Manu Youtube Player 2.0  」
      ...
      */
      ...
      // await Queen Manu.sendMessage(from, {audio: fs.readFileSync(ytmp3play.path),fileName: anu.title + '.mp3',mimetype: 'audio/mpeg',}, {quoted:m})
      // }
      // break;
  ...
  🔗 *Url :* ${anu.url}\n`,
        ...
        await Queen Manu.sendMessage(from, {
      ...
      case 'ytvd': case 'video': case 'ytvideo': case 'ytmp4': {
        ...
        Queen Manu.sendMessage(from, { video: { url: ytmp4play.videoUrl }, mimetype: "video/mp4", caption: anu.title + ' By *Queen Manu MD*', }, { quoted: m })
      }
      ...
      const YT=require('./lib/ytdlcore')
      if(!text) return Queen Manu.sendMessage(from,{text:"Please provide a valid youtube link!"},{quoted:m})
      let yts = require("@adiwajshing/keyed-db2")
      let search = await yts(text)
      let anu = search.videos[0]
      let buttons = [
      ...
      let buttonMessage = {
      image: { url: anu.thumbnail },
      caption: `「  Queen Manu Youtube Downloader 2.0  」
      ...
      */
      ...
      case 'ytmp3': {
        ...
        await Queen Manu.sendMessage(from, { document: fs.readFileSync(ytmp3play2.path), fileName: 'Queen Manu_YTmp3_Downloader.mp3', mimetype: 'audio/mpeg', }, { quoted: m })
      }
        break;
      ...
      case 'ytvd2': case 'ytmp4': {
        ...
        Queen Manu.sendMessage(from, { video: { url: ytmp4play2.videoUrl }, mimetype: "video/mp4", caption: 'Downloaded by *Queen Manu MD*', }, { quoted: m })
      }
        break;
...
`.trim())
      ...
      //        Queen Manu.sendMessage(m.chat, { image: { url: random.male }, caption: `For him...` }, { quoted: m })
      //        Queen Manu.sendMessage(m.chat, { image: { url: random.female }, caption: `For her...` }, { quoted: m })
      //    }
      // break;
      ...
      case 'ppcouple': {
        ...
        for (let i = 0; i < 3; i++) {  // the set of picures.
          ...
          await Queen Manu.sendMessage(m.chat, { image: { url: random.male }, caption: `For him...` }, { quoted: m });

          // Sending the female picture
          await Queen Manu.sendMessage(m.chat, { image: { url: random.female }, caption: `For her...` }, { quoted: m });
        }
      }
        break;
      ...
      // Queen Manu.sendMessage(m.chat, { image: { url: result }, caption: '⭔ Media Url : '+result }, { quoted: m })
      // }
      // break;
      ...
      case 'pin': {
        ...
        for (let i = 0; i < results.length; i++) {
          Queen Manu.sendMessage(m.chat, { image: { url: results[i] } }, { quoted: m });
        }
      }
        break;
      ...
      //   const commonCaption = 'Check out this image from Pinterest By Queen Manu';
      //   for (let i = 0; i < results.length; i++) {
      //     Queen Manu.sendMessage(m.chat, { image: { url: results[i] }, caption: commonCaption }, { quoted: m });
      //   }
      // }
      // break;
      ...
      case 'swm': case 'take': case 'stickerwm': case 'steal': {
        ...
        if (!args.join(" ")) return reply(`Like use -take Queen Manu|By: Kai`)
        const swn = args.join(" ")
        const pcknm = swn.split("|")[0];
        const atnm = swn.split("|")[1];
        if (m.quoted.isAnimated === true) {
          Queen Manu.downloadAndSaveMediaMessage(quoted, "gifee")
          Queen Manu.sendMessage(from, { sticker: fs.readFileSync("gifee.webp") }, { quoted: m })
        } else if (/image/.test(mime)) {
          let media = await quoted.download()
          let encmedia = await Queen Manu.sendImageAsSticker(m.chat, media, m, { packname: pcknm, author: atnm })
          await fs.unlinkSync(encmedia)
        } else if (/video/.test(mime)) {
          if ((quoted.msg || quoted).seconds > 11) return reply('Maximum 10 seconds is allowed!')
          let media = await quoted.download()
          let encmedia = await Queen Manu.sendVideoAsSticker(m.chat, media, m, { packname: pcknm, author: atnm })
          await fs.unlinkSync(encmedia)
        } else {
      ...
      case 'smeme': case 'stickermeme': case 'stickmeme': {
        ...
        reply(mess.wait)
        mee = await Queen Manu.downloadAndSaveMediaMessage(quoted)
        mem = await TelegraPh(mee)
        meme = `https://api.memegen.link/images/custom/-/${text}.png?background=${mem}`
        memek = await Queen Manu.sendImageAsSticker(m.chat, meme, m, { packname: global.packname, author: global.author })
      ...
      case 'sgif': case 'sticker': case 's': {
        ...
        if (/image/.test(mime)) {
          let media = await quoted.download()
          let encmedia = await Queen Manu.sendImageAsSticker(m.chat, media, m, { packname: global.packname, author: global.author })
          await fs.unlinkSync(encmedia)
        } else if (/video/.test(mime)) {
          if ((quoted.msg || quoted).seconds > 11) return reply('Maximum 10 seconds!')
          let media = await quoted.download()
          let encmedia = await Queen Manu.sendVideoAsSticker(m.chat, media, m, { packname: global.packname, author: global.author })
          await fs.unlinkSync(encmedia)
        } else {
      ...
      // ]
      // await Queen Manu.sendButtonText(m.chat, buttons, jawab, Queen Manu.user.name, m, {mentions: menst})
      // }
      // break;
      ...
      // ]
      // await Queen Manu.sendButtonText(m.chat, buttons, jawab, Queen Manu.user.name, m, {mentions: ments})
      // }
      // break;
      ...
      case 'soulmate': {
        ...
        Queen Manu.sendMessage(m.chat, { text: message, mentions: [me, jodoh] }, { quoted: m });
      }
        break;
      ...
      case 'handsomecheck':
        ...
        Queen Manu.sendMessage(from, { text: `*${command}*\n\nName : ${q}\nAnswer : *${teng}%*` }, { quoted: m })
        break;
      ...
      case 'charactercheck':
        ...
        if (!text) return reply(`Tag Someone, Example : ${prefix + command} @Kai`)
        const Queen Manutttt = ['Compassionate', 'Generous', 'Grumpy', 'Forgiving', 'Obedient', 'Good', 'Simp', 'Kind-Hearted', 'patient', 'UwU', 'top, anyway', 'Helpful']
        const taky = Queen Manutttt[Math.floor(Math.random() * Queen Manutttt.length)]
        Queen Manu.sendMessage(from, { text: `Character Check : ${q}\nAnswer : *${taky}*` }, { quoted: m })
        break;
      ...
      case 'dare':
        ...
        const Queen Manudareww = dare[Math.floor(Math.random() * dare.length)]
        buffer = await getBuffer(`https://images4.alphacoders.com/101/1016619.jpg`)
        Queen Manu.sendMessage(from, { image: buffer, caption: '*You have chosen Dare...*\n\n' + Queen Manudareww }, { quoted: m })
        break;
      ...
      case 'truth':
        ...
        const Queen Manutruthww = truth[Math.floor(Math.random() * truth.length)]
        buffer = await getBuffer(`https://images2.alphacoders.com/650/650812.jpg`)
        Queen Manu.sendMessage(from, { image: buffer, caption: '*You have chosen Truth...*\n' + Queen Manutruthww }, { quoted: m })
        break;
      ...
      case 'nsfwQueen Manu':
        ...
        Queen Manu.sendMessage(from, { image: { url: nye }, caption: "Master..." }, { quoted: m })
        break;
...
*Link* : ${baby1[0].link}`
        reply(`${result4}`)
        Queen Manu.sendMessage(m.chat, { document: { url: baby1[0].link }, fileName: baby1[0].nama, mimetype: baby1[0].mime }, { quoted: m }).catch((err) => reply(mess.error))
      }
        break;
      ...
      // // Queen Manu.sendMessage(from, {image:{url:buffer}, caption:"Here you go!"}, {quoted:m})


      // // // NoHorny = await fetchJson(`https://fantox-apis.vercel.app/${command}`)
      // // // YesHorny = await getBuffer(NoHorny.result)
      // // // Queen Manu.sendMessage(from, {image:YesHorny},{quoted:m})
      // // // } catch (e) {error("Error")}	
      // // break;
      ...
      //       await Queen Manu.sendMessage(m.chat,{video: spgif, gifPlayback:true},{ quoted:m }).catch(err => {
      //                   return reply('Error!')
      //                                   })
      // break;
      ...
      //       await Queen Manu.sendMessage(m.chat,{video: bjif, gifPlayback:true},{ quoted:m }).catch(err => {
      //                   return reply('error..')
      //                                   })
      // break;
      ...
      // headerType: 1 */
      // }     
      //           await Queen Manu.sendMessage(m.chat, button2Messages, { quoted:m }).catch(err => {
      //                   return('Error!')
      //               })
      // break;
      ...
      // headerType: 1 */
      // }      
      //           await Queen Manu.sendMessage(m.chat, button3Messages, { quoted:m }).catch(err => {
      //                   return('Error!')
      //               })
      // break;
      ...
      // headerType: 1 */
      // }      
      //           await Queen Manu.sendMessage(m.chat, button4Messages, { quoted:m }).catch(err => {
      //                   return('Error!')
      //               })
      // break;
      ...
      //     headerType: 4 */
      //     }     
      //           await Queen Manu.sendMessage(m.chat, buttonsssMessages,{ quoted:m }).catch(err => {
      //                   return('Error!')
      //               })
      // break;  
...
{buttonId: `${prefix}smug2`, buttonText: {displayText: `>>`}, type: 1},
        ...
        await Queen Manu.sendMessage(m.chat, button1ssMessages, { quoted: m }).catch(err => {
          return ('Error!')
        })
        break;
   ...
   {buttonId: `${prefix}foxgirl`, buttonText: {displayText: `>>`}, type: 1},
        ...
        await Queen Manu.sendMessage(m.chat, button12ssMessages, { quoted: m }).catch(err => {
          return ('Error!')
        })
        break;
      ...
      case 'animenom':
        ...
        await Queen Manu.sendMessage(m.chat, xx1button3Messages, { quoted: m }).catch(err => {
          return ('Error!')
        })
        break;
...
{buttonId: `${prefix}waifu3`, buttonText: {displayText: `>>`}, type: 1},
        ...
        await Queen Manu.sendMessage(m.chat, button112ssMessages, { quoted: m }).catch(err => {
          return ('Error!')
        })
        break;
   ...
   {buttonId: '-crossplay', buttonText: {displayText: '>>'}, type: 1},
        ...
        await Queen Manu.sendMessage(m.chat, cosplybutton, { quoted: m }).catch(err => {
          return ('Error!')
        })
      ...
      case 'neko2':
        ...
        await Queen Manu.sendMessage(m.chat, buttonssMessage, { quoted: m }).catch(err => {
          return ('Error!')
        })
        break;
      ...
      case 'tickle':
        ...
        await Queen Manu.sendMessage(m.chat, buttonssMessages, { quoted: m }).catch(err => {
          return ('Error!')
        })
        break;
      ...
      case 'cry': case 'handhold': {
        ...
        try {
          ...
          Queen Manu.sendMessage(m.chat, { video: fetchedgif, gifPlayback: true, mentions: ment, caption: musers }, { quoted: m })
        } catch (error) {
          console.log(error);
        }
      }
      ...
      let resmain = await GIFBufferToVideoBuffer(resffj)   
          await Queen Manu.sendMessage(m.chat,{video: resmain, gifPlayback:true},{ quoted:m }).catch(err => {
                      return reply('error..')
                                      })
      break;
      ...
      */
      ...
      case 'megumin':
        ...
        await Queen Manu.sendMessage(m.chat, buttonzMessage, { quoted: m }).catch(err => {
          return ('Error!')
        })
        break;
      ...
      case 'awoo':
        ...
        await Queen Manu.sendMessage(m.chat, button1Messages, { quoted: m }).catch(err => {
          return ('Error!')
        })
        break;
      ...
      case 'animewall2': case 'animewallpaper2':
        ...
        await Queen Manu.sendMessage(m.chat, wal, { quoted: m }).catch(err => {
          return ('Error!')
        })
        break;
      ...
      //     ""
      //   )}`
      // Queen Manu.sendMessage(m.chat,{image:{url:result.images.jpg.large_image_url},caption:details},{quoted:m})   
      // break;
  ...
  ❄ *Description:* ${anime.synopsis}*`
        await Queen Manu.sendMessage(m.chat, { image: { url: anime.picture }, caption: animetxt }, { quoted: m })
      }
        break;
      ...
      case 'manga':
        ...
        Queen Manu.sendMessage(m.chat, { image: { url: srh.data[0].images.jpg.large_image_url }, caption: mang }, { quoted: m })
        break;
      ...
      case 'waifu':
        ...
        await Queen Manu.sendMessage(m.chat, button4Messagess, { quoted: m }).catch(err => {
          return ('error..')
        })
        break;
      ...
      case 'neko':
        ...
        await Queen Manu.sendMessage(m.chat, buttonMessagessf, { quoted: m }).catch(err => {
          return ('error..')
        })
        break;
      ...
      case 'loli':
        ...
        await Queen Manu.sendMessage(m.chat, buttonMessagessfgr, { quoted: m }).catch(err => {
          return ('error..')
        })
        break;
      ...
      case 'bc': case 'broadcast': case 'bcall': {
        ...
        for (let yoi of anu) {
          ...
          Queen Manu.send5ButImg(yoi, txt, `${global.BotName}`, BotLogo, btn, Thumb)
        }
...
Hemlo, I am "Queen Manu" a WhatsApp bot create and recode by Mr Senuwai to do everything that is possible on WhatsApp based on WhatsApp Multi Device(MD) Support.

 ═══════════════════════

     ⏤͟͟͞͞ꪶ🍃 𝗤𝘂𝗲𝗲𝗻 𝗠𝗮𝗻𝘂 𝗠𝗗 𝗕𝗼𝘁 🍃ꫂ ͟͞⏤
 ...
 ═══════════════════════
   ...
   *Developed By Mr Senuwa*`
        let buttonMessage = {
          video: fs.readFileSync('./system/Queen Manu_3.mp4'), gifPlayback: true,
          caption: helpmenu,
      ...
      case 'qr': case 'scanner': case 'qrcode':
        ...
        var replqr = await getBuffer(`https://Queen Manu-qr-scanner.broken0007.repl.co/`)
        /*        var qrbutton = [
{buttonId: `${prefix}qr`, buttonText: {displayText: `Tap to Re-run Repl`}, type: 1}
        ...
        await Queen Manu.sendMessage(m.chat, bmffg, { quoted: m }).catch(err => {
          return ('Error!')
        })
        break;
      ...
      case 'weather':
        ...
        Queen Manu.sendMessage(from, { video: { url: 'https://media.tenor.com/bC57J4v11UcAAAPo/weather-sunny.mp4' }, gifPlayback: true, caption: weathertext }, { quoted: m })
      ...
      case 'waifucheck':
        ...
        const Queen Manukak = okebnh1[Math.floor(Math.random() * okebnh1.length)]
        Queen Manu.sendMessage(m.chat, { text: Queen Manukak }, { quoted: m })
        break;
      ...
      default:
        ...
        if (budy.startsWith('=>')) {
          ...
          try {
            ...
            Queen Manu.sendMessage(from, { image: ErrorPic, caption: String(e) }, { quoted: m })
          }
        }
        if (budy.startsWith('>')) {
          if (!isCreator) return reply(mess.botowner)
          try {
            ...
            await Queen Manu.sendMessage(from, { image: ErrorPic, caption: String(err) }, { quoted: m })
          }
        }
        ...
        if (budy.startsWith('$')) {
          ...
          exec(budy.slice(2), (err, stdout) => {
            if (err) return Queen Manu.sendMessage(from, { image: ErrorPic, caption: String(err) }, { quoted: m })
        ...
        if (isCmd && budy.toLowerCase() != undefined) {
          ...
          Queen Manu.copyNForward(m.chat, msgs[budy.toLowerCase()], true)
        }
    }
  } catch (err) {
    Queen Manu.sendMessage(`${ownertag}@s.whatsapp.net`, util.format(err), { quoted: m })
    console.log(err)
  }
}
